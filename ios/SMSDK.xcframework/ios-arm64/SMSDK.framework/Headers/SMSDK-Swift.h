// Generated by Apple Swift version 5.4.2 (swiftlang-1200.0.45 clang-1200.0.32.28)
#ifndef SMSDK_SWIFT_H
#define SMSDK_SWIFT_H
...
#define SWIFT_CLASS(SWIFT_NAME) SWIFT_RUNTIME_NAME(SWIFT_NAME) \
SWIFT_CLASS_EXTRA
#define SWIFT_CLASS_NAMED(SWIFT_NAME) SWIFT_COMPILE_NAME(SWIFT_NAME) \
SWIFT_CLASS_EXTRA
#endif
#endif
...
#define SWIFT_PROTOCOL_NAMED(SWIFT_NAME) SWIFT_COMPILE_NAME(SWIFT_NAME) \
SWIFT_PROTOCOL_EXTRA
#endif
...
#undef any
#pragma clang attribute push(__attribute__((external_source_symbol(language = "Swift", defined_in = "SMSDK", generated_declaration))), apply_to = any(function, enum, objc_interface, objc_category, objc_protocol))
